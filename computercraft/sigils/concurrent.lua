--- concurrent.lua is the concurrency module adapted from Artist
--- (see https://github.com/SquidDev-CC/artist/blob/vnext/src/artist/lib/concurrent.lua)
--- and is provided with a separate (BSD) license from the rest of the CCPipes/SIGILS project
